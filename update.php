...
if (!isset($_POST["btnSearch"])){
	...
	if ($_POST["patrolCarStatus"] == '4'){
		...
		$sql = "UPDATE dispatch SET time arrived = NOW()
	...
	$sql = "UPDATE dispatch SET time completed = NOW()
		        WHERE time_arrived is NULL AND patrolcar_id = ?";
	...
	// last but not least, update incident table to completed (30) all patrol car attended to it are FREE now
...
<!---START OF STEP 10 IN THE PROJECT 7 PROGRAM AND DEPLOY_V1.DOCX--->
               <!-- display a form operator to update status of patrol car -->
